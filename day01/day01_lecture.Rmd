...
## What is R?
  ...
  - ecosystem
    - packages (> 12000 on [CRAN](http://cran.r-project.org/web/packages/) and counting! Last year this time, it was 9870)
    - user community
...
## Completing the Final Project {.smaller}
  - the Final Project has several requirements:
    - proposal due 11:59 PM EST, Sunday, January 7
    - proposal revision (if needed) due by time specified by instructor
    - final code due 8:00 PM EST, Tuesday, January 23
...
## Testing version control {.smaller}
  ...
  - In RStudio, go to File > New Project...
    - Version Control
    - Git
    - https://github.com/scottrjackson/r_programming_bsos_winter2018.git
